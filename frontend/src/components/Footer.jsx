    ...
    <div>
      ...
      <div className="max-w-[1280px] mx-auto px-4 sm:px-6 lg:px-8 py-10 flex flex-wrap justify-between items-start gap-8">
        ...
        <div className="flex flex-col gap-4 max-w-[280px]">
          <img src={logo} alt="Fixion Logo" className="w-[80px] object-contain" />
          <p className="text-sm text-neutral-700 leading-relaxed text-left max-w-[300px] ">
            Fixion is a platform built to help people find local trusted artisans 
            (like plumbers, electricians, caterers etc.) quickly and easily.
          </p>
        ...
        <div className="flex flex-col gap-4">
          ...
          <button className="bg-indigo-950 text-white rounded-full px-6 py-2 text-sm font-semibold w-fit">
            Create Account
          </button>
        </div>
      </div>
